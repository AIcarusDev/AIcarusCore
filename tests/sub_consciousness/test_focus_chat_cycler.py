...
class TestFocusChatCycler(unittest.TestCase):
    ...
    def test_final_summary_is_saved_on_shutdown(self):
        """
        ...
        self.mock_session.events_since_last_summary = [
            {'event_id': 'event_final_1'},
            {'event_id': 'event_final_2'}
        ]
    ...
    def test_shutdown_does_not_save_empty_summary(self):
        """
