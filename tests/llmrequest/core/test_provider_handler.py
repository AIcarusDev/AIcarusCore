...
class TestGoogleApiHandler:
    ...
    def test_prepare_chat_request_path(self, google_handler: GoogleApiHandler):
        ...
        path, _, _, _ = google_handler.prepare_request_data(
            ...
            is_streaming=False,
            prompt="hello",
            system_prompt=None, processed_images=None, final_generation_config={},
            tools=None, tool_choice=None, text_to_embed=None, enable_google_search=False
        )
        assert path == "/models/gemini-1.5-pro:generateContent"

    def test_prepare_embedding_request_path(self, google_handler: GoogleApiHandler):
        ...
        path, _, _, _ = google_handler.prepare_request_data(
            ...
            prompt=None,
            system_prompt=None, processed_images=None, final_generation_config={},
            tools=None, tool_choice=None, text_to_embed="some text", enable_google_search=False
        )
        assert path == "/models/text-embedding-004:embedContent"

    def test_prepare_request_with_system_prompt(self, google_handler: GoogleApiHandler):
        ...
        _, _, _, payload = google_handler.prepare_request_data(
            ...
            processed_images=None, final_generation_config={},
            tools=None, tool_choice=None, text_to_embed=None, enable_google_search=False
        )
...
class TestOpenAIApiHandler:
    ...
    def test_prepare_chat_request_path(self, openai_handler: OpenAIApiHandler):
    ...
    def test_prepare_request_with_tools(self, openai_handler: OpenAIApiHandler):
        ...
        _, _, _, payload = openai_handler.prepare_request_data(
            ...
            system_prompt=None, processed_images=None, final_generation_config={},
            tools=tools, tool_choice="auto", text_to_embed=None, enable_google_search=False
        )
