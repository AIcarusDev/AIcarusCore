        ...
        definitions = {
            "web_search": {
                ...
                "properties": {
                    ...
                    "max_results": {"type": "integer", "description": "期望返回的最大结果数量 (可选, 默认 5)。"},
                },
                "required": ["query"],
            },
            "report_action_failure": {
                ...
                "properties": {
                    "reason_for_failure_short": {"type": "string", "description": "简要说明为什么这个动作无法执行。"}
                },
        ...
        for tool_name, tool_func in all_tools.items():
            if tool_name not in definitions:
                definitions[tool_name] = {
                    ...
                    "properties": {"params": {"type": "object", "description": "工具所需的参数字典。"}},
                }
        return definitions
