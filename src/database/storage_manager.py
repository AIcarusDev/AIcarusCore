...
from src.common.utils import MessageContentProcessor, format_chat_history_for_prompt
from .models import Event, ActionRecord, Collections, DATABASE_INDEXES
...
class StorageManager:
    ...
    async def get_recent_conversation_events(
        self, 
        conversation_id: str, 
        limit: int = 50
    ) -> List[Dict[str, Any]]:
        ...
        return await self.get_events(
            event_types=["message.group.normal", "message.private.normal"],
