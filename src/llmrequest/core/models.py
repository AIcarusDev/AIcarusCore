...
class RateLimitError(NetworkError):
    ...
    def __init__(self, message: str, status_code: int = 429, response_text: str | None = None, key_identifier: str | None = None):
...
class PermissionDeniedError(NetworkError):
    ...
    def __init__(self, message: str, status_code: int, response_text: str | None = None, key_identifier: str | None = None):
        super().__init__(message, status_code=status_code)
        self.response_text = response_text
        self.key_identifier = key_identifier
...
class PayloadTooLargeError(NetworkError):
    ...
    def __init__(self, message: str, status_code: int = 413, response_text: str | None = None):
        super().__init__(message, status_code=status_code)
        self.response_text = response_text
...
class APIKeyManager:
    ...
    def __init__(self, initial_keys: list[str], abandoned_keys_config: set[str], rate_limit_disable_seconds: int):
    ...
    def get_available_keys(self) -> list[str]:
        ...
        keys_to_reactivate = [
            k for k, expiry_ts in self._temporarily_disabled_keys.items()
        ...
        available = [
            key for key in self.initial_keys
    ...
    def temporarily_disable_key(self, key: str):
    ...
    def permanently_abandon_key(self, key: str):
    ...
    def reset_temporary_disable_list(self):
