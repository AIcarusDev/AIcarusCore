...
class ApiProviderHandler(ABC):
    ...
    def prepare_request_data(
        ...
        """Prepare path, params, headers, and payload for the OpenAI API request.
        ...
        request_type : str
            The type of request (e.g., 'generate', 'embed', 'tool_call').
        is_streaming : bool
        ...
        -------
        tuple[str, dict, dict, dict]
            A tuple containing (path, params, headers, payload) for the API request.
        """
        """Prepare path, params, headers, and payload for the OpenAI API request.
...
class GoogleApiHandler(ApiProviderHandler):
    ...
    This class implements the ApiProviderHandler interface for Google's Generative AI API,
    handling request preparation, response parsing, and streaming for both
    ...
    def prepare_request_data(
        ...
        """Prepare path, params, headers, and payload for the Google API request.
    ...
    def parse_non_streaming_response(
        ...
        -------
        dict[str, Any]
            Dictionary containing parsed text, tool_calls, embedding, and raw response.
        """
        parsed = {
            "text": None,
            "tool_calls": None,
    ...
    async def handle_streaming_response(
        ...
        """Handle and parse a streaming response from the OpenAI API.
        ...
        -------
        dict[str, Any]
            Dictionary containing the full text and interruption status.
        """
        full_text = ""
...
class OpenAIApiHandler(ApiProviderHandler):
    ...
    This class implements the ApiProviderHandler interface for OpenAI's API,
    handling request preparation, response parsing, and streaming for both
    text generation and embedding requests.
    """
